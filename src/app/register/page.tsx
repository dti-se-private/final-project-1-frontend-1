    ...
    return (
        <div className="py-8 flex flex-col justify-center items-center min-h-[80vh]">
            <div className="container flex flex-col justify-center items-center gap-8">
                ...
                <Button className="w-2/3 md:w-1/3 py-2 px-4 bg-blue-700 text-white shadow-md hover:bg-blue-600 transition duration-300 ease-in-out flex items-center justify-center gap-2"
                        onPress={() => googleLogin()}
                >
                    <FcGoogle size={24} />
